        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 h-full">
          ...
          >
            <div className="space-y-6">
              ...
              >
                Portal data terbuka yang menghadirkan berbagai informasi publik
                Pemerintah Kota Cirebon secara mudah diakses, transparan, dan
                dapat dimanfaatkan oleh siapa saja. Dengan prinsip keterbukaan
                informasi, Open Data mendorong partisipasi masyarakat, mendukung
                penelitian, serta membuka peluang inovasi dan kolaborasi
                berbasis data.
              </MotionP>
          ...
          <MotionDiv
            ...
            className="space-y-20 pt-16 pb-16 hidden lg:block"

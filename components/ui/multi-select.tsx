...
>(
  (
    ...
    // Use value prop directly for controlled component, fallback to defaultValue for uncontrolled
    ...
    const selectedOptions = React.useMemo(() => 
      selectedValues.map(value => optionsMap.get(value)).filter(Boolean),
    ...
    const handleBadgeClick = React.useCallback((event: React.MouseEvent, value: string) => {
    ...
    const handleClearExtraClick = React.useCallback((event: React.MouseEvent) => {
      event.preventDefault();
      event.stopPropagation();
      clearExtraOptions();
    }, [clearExtraOptions]);
                  ...
                  {visibleOptions.map((option) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {option?.label}
                        <div
                          onClick={(event) => handleBadgeClick(event, option.value)}
                        >
